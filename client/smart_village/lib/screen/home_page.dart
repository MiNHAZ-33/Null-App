      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            const SizedBox(height: 10),
            const HealthCard(
                title: 'এআই দ্বারা রোগ ডিটেকশন',
                subtitle: 'ডিপ লার্নিং এর মাধ্যমে দ্বারা রোগ ডিটেকশন করা যাবে'),
            const SizedBox(height: 3),
            const HealthCard(
                title: 'অনলাইন ডাক্তার',
                subtitle:
                    'অভিজ্ঞ চিকিৎসকের মাধ্যমে অনলাইনে চিকিৎসা পাওয়া যাবে'),
            const SizedBox(height: 3),
            const HealthCard(
